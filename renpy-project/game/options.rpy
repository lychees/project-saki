...
define config.name = _("天才算法少女 (Ren'Py 重制版)")

## 分辨率与原作 GameCreator 版一致：1200x720
...
OI / 信息学竞赛题材的 galgame。原作为未完成 Demo，
本重制版忠实复刻原作已实装的全部剧情内容，未实装部分以提示卡标注。
...
define build.name = "tensai-algorithm-shoujo"
...
define config.main_menu_music = "audio/bgm/Title.mp3"
...
define config.save_directory = "tensai-algorithm-shoujo-renpy"
